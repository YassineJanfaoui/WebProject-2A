...
$c = new DoctorC();
$table = $c->listDoctorsbysprecialityDESC(); // Check function name "listDoctors" in DoctorController.php
?>
<html>
    <head>
        <style>
            ...
            <div class="search">
                ...
                <div style="position:relative;left:40px;">
                    ...
                    <form id="sortForm" action="" method="POST">
                        ...
                        <option value="sortasc.php">Sort Ascending Order</option>
                        <option value="sortdesc.php">Sort Descending Order</option>
                        </select>
                    </form>
                </div>
            </div>
