...
if (isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["first_name"]) && isset($_POST["family_name"]) && isset($_POST["email_address"]) && isset($_POST["contact_number"]) && isset($_POST["g-recaptcha-response"])) //input control
{
...
<body>
  ...
  <form action="" method="POST" id="form">
    ...
    <div class="input_box">
      <div class="g-recaptcha" style="position:relative;left:250px;" data-callback="captcha_filled" data-expired-callback="captcha_expired" data-sitekey="6Lfb2ygpAAAAALdQ1lef4OmoUTdaxgvre-WpTYPz"></div>
    </div>
