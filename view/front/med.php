...
$tabbb = $b->listpatientdetails($_SESSION['user_id']);
...
<body>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../../assets/img/bg_image_1.jpg);">
    ...
    <div class="container">
        <h2 class="text- mb-4">Care Information</h2>
        <table class="table">
            <thead>
                <tr>
                    <th>Patient Id</th>
            ...
            <tbody>
                ...
                foreach ($tabbb as $medical_care) : ?>
                    ...
                    <td><?php echo isset($medical_care['patient_name']) ? $medical_care['patient_name'] : ''; ?></td>
                    <td><?php echo isset($medical_care['medecine_name']) ? $medical_care['medecine_name'] : ''; ?></td>
